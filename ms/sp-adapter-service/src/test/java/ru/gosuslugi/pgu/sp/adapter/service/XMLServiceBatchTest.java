...
public abstract class XMLServiceBatchTest {
    ...
    public XMLServiceBatchTest(String roleId, Long oid, String directory, TestPdfMode testPdfMode) throws IOException {
        this.roleId = roleId;
        this.oid = oid;
    ...
    public static ServiceDescriptorClient getServiceDescriptorClient(String scenarioJson) {
        return new ServiceDescriptorClient() {
            ...
            @Override
            public Map<String, String> getTemplatePackageChecksums(Collection<String> serviceId) {
                return null;
            }
        };
    }
